...
- laplace u(x) + V u(x) = 1 for x in [-1,1] x [-1,1]
...
Fe = sps.kron(F_hat, F_hat) \
   + g0 * (sps.kron(G_hat0, F_hat) + sps.kron(F_hat, G_hat0)) \
   + g0 * (sps.kron(G_hat1, F_hat) + sps.kron(F_hat, G_hat1)) 
