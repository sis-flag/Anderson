...
#X, Y = np.meshgrid(x, x)
#plt.figure()
#plt.pcolor(X, Y, KV.T, cmap='rainbow')
#plt.colorbar()
#plt.title("potential")
#plt.savefig("../pics/v10.png")
#plt.show()
#    
#plt.figure()
#plt.pcolor(x1, x2, w, cmap='rainbow')
#plt.colorbar()
#plt.title("landscape")
#plt.savefig("../pics/w10.png")
#plt.show()

#plt.figure()
#for ind in range(4):
#    plt.subplot(2, 2, ind+1)
#    plt.pcolor(x1, x2, u[ind], vmin=-0.5, vmax=1, cmap='rainbow')
#    plt.title("eigen mode"+str(ind+1))
#    plt.colorbar()
#plt.savefig("../pics/u13.png")
#plt.show()
#
#alpha = 1 / np.max(w)
#
...
#for ind in range(4):
#    plt.subplot(2, 2, ind+1)
#    cax = plt.pcolor(x1, x2, w*(lam[ind]+alpha+beta), vmin=1, vmax=1.001)
#    cax.cmap.set_under('black')
#    cax.cmap.set_over('white')
#    plt.title("landscape mode"+str(ind+1))
#plt.savefig("../pics/wm13.png")
#plt.show()
#
#scipy.io.savemat('a.mat',{"w":w})
